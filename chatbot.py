...
#sepearting the questions and the answers
questions = []
answers = []
...
#create dictionaries that map the questions words and the answers words to a unique integer
...
#converting data into sequence of unique integers
...
#------------------ STEP 2 - SEQ2SEQ MODEL ------------------
 
#placeholder for inputs targets and other parameters
def model_inputs():
...
#sequence_length setting
sequence_length = tf.placeholder_with_default(25, None, name = 'sequence_length')
 
#getting input tensor shape
